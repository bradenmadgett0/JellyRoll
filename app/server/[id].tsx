...
export default function ServerDetailScreen() {
  ...
  const handleDelete = () => {
    ...
    if (Platform.OS === "web") {
      if (
        confirm(`Remove "${server.name}"? This will delete saved credentials.`)
      ) {
        doDelete();
      }
    } else {
              ...
              <Ionicons
                ...
                color={
                  server.isHttps
                    ...
                    : (styles.warningColor.color as string)
                }
              />
              <Text
                style={[
      ...
      <Animated.View entering={FadeInDown.duration(500).delay(200)}>
        ...
        >
          {isTesting ? (
            <ActivityIndicator
              size="small"
              color={styles.testButtonText.color as string}
            />
          ) : (
            <Ionicons
              name="pulse"
              size={20}
              color={styles.testButtonText.color}
            />
          )}
            ...
            style={[
              styles.testResultBanner,
              {
                backgroundColor: testResult.success
                  ? (styles.successColor.color as string) + "15"
                  : (styles.errorColor.color as string) + "15",
              },
            ]}
          >
            <Ionicons
              ...
              color={
                testResult.success
                  ? (styles.successColor.color as string)
                  : (styles.errorColor.color as string)
              }
            />
            <Text
              style={[
