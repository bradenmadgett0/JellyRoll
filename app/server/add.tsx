      ...
      >
                  ...
                  >
                    ...
                    >
                      ...
                      <Text style={styles.typeLabel}>
                        {SERVER_TYPE_LABELS[st.type]}
                      </Text>
                      <Text style={styles.typeDescription}>
                        {SERVER_TYPE_DESCRIPTIONS[st.type]}
                      </Text>
                    </TouchableOpacity>
                  </Animated.View>
                );
          ...
          <Animated.View entering={FadeInRight.duration(400)}>
            ...
            >
              <Ionicons
                ...
                color={
                  useHttp
                    ? (styles.httpWarning.color as string)
                    : (styles.inputHint.color as string)
                }
              />
              <View>
                <Text style={styles.httpToggleText}>
                  Allow HTTP (local network)
                </Text>
                {useHttp && (
                  <Text style={styles.httpWarning}>
                    ⚠️ HTTP is not encrypted. Only use on trusted local
                    networks.
                  </Text>
                )}
              </View>
            ...
            {!isJellyfin && (
              <View style={styles.inputGroup}>
                ...
                <Text style={styles.inputHint}>
                  Found in {SERVER_TYPE_LABELS[serverType!]} → Settings →
                  General → API Key
                </Text>
              </View>
            )}
        ...
        {step === "testing" && (
          ...
          >
            ...
            <Text style={styles.testingSubtext}>{normalizeUrl(url)}</Text>
          </Animated.View>
        )}
          ...
          >
            <View style={styles.successIconBg}>
              <Ionicons
                ...
                size={64}
                color={styles.successTitle.color}
              />
            </View>
            ...
            <Text style={styles.successMessage}>
              Your {SERVER_TYPE_LABELS[serverType!]} server has been added
              successfully.
              {isJellyfin
