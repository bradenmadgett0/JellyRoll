          ...
          <View style={styles.badgeRow}>
            <View
              style={[
                styles.badge,
                {
                  backgroundColor: artist.monitored
          ...
          >
            ...
            <View style={styles.stat}>
              <Text style={styles.statValue}>
                {stats.trackFileCount ?? 0}/{stats.trackCount ?? 0}
              </Text>
              <Text style={styles.statLabel}>Tracks</Text>
            </View>
            <View style={styles.stat}>
              <Text style={styles.statValue}>
                {stats.sizeOnDisk ? formatSize(stats.sizeOnDisk) : "--"}
              </Text>
            ...
            <View style={styles.stat}>
              <Text style={styles.statValue}>
                {stats.trackCount && stats.trackCount > 0
                  ? Math.round(
                      ((stats.trackFileCount ?? 0) / stats.trackCount) * 100,
                    )
                  : 0}
                %
              </Text>
              ...
              return (
                ...
                >
                  <View style={styles.albumCard}>
                    ...
                    <View
                      style={[
                        styles.albumStatusBadge,
                        {
                          backgroundColor: album.monitored
                            ? styles.lidarrColor.color + "20"
                            : styles.iconTertiary.color + "10",
                        },
                      ]}
                    >
                      <Ionicons
                        ...
                        color={
                          album.monitored
                            ? (styles.lidarrColor.color as string)
                            : (styles.iconTertiary.color as string)
                        }
                      />
                    </View>
