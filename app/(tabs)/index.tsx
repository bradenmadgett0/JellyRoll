        ...
        >
          ...
          >
            <Ionicons
              name="add-circle"
              size={22}
              color={styles.addServerButtonText.color}
            />
            <Text style={styles.addServerButtonText}>
            ...
            {servers.map((server, index) => (
              ...
              >
                <TouchableOpacity
                  style={[
                    styles.serverCard,
                    { borderLeftColor: SOURCE_COLORS[server.type] },
                  ]}
                ...
                >
                  ...
                  <Text style={styles.serverCardName} numberOfLines={1}>
                    {server.name}
                  </Text>
