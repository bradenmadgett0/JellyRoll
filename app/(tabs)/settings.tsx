              ...
              >
                <View style={styles.serverRowLeft}>
                  <View
                    style={[
                      styles.serverIcon,
                      { backgroundColor: SOURCE_COLORS[server.type] + "20" },
                    ]}
                  >
                    <Ionicons
        ...
        <Animated.View entering={FadeInDown.duration(500).delay(150)}>
          ...
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              trackColor={{
                false: styles.switchTrack.backgroundColor as string,
                true: styles.switchTrackActive.backgroundColor as string,
              }}
              thumbColor={
                showSubtitles
                  ? (styles.switchThumbActive.backgroundColor as string)
                  : (styles.switchThumb.backgroundColor as string)
              }
            />
          </View>
        </Animated.View>
          ...
          <View style={styles.settingRow}>
            <View style={styles.settingLeft}>
              <Ionicons
                name="notifications"
                size={20}
                color={styles.iconWarning.color}
              />
        ...
        <Animated.View entering={FadeInDown.duration(500).delay(400)}>
          ...
          <View style={styles.securityInfo}>
            ...
            <Text style={styles.securityText}>
              API keys and tokens are encrypted using{" "}
              {Platform.OS === "ios"
                ? "iOS Keychain"
                : Platform.OS === "android"
                  ? "Android Keystore"
