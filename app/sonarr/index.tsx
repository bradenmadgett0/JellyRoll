                ...
                >
                    {posterUrl ? (
                        ...
                        <View style={[styles.poster, styles.posterPlaceholder]}>
                            <Ionicons name="tv" size={24} color={styles.iconTertiary.color} />
                        </View>
                    )}
                    <View style={styles.seriesInfo}>
                        ...
                        <View style={styles.tagsRow}>
                            <View style={[styles.statusBadge, { backgroundColor: item.monitored ? styles.successColor.color + '20' : styles.iconTertiary.color + '20' }]}>
                                <Text style={[styles.statusText, { color: item.monitored ? (styles.successColor.color as string) : (styles.iconTertiary.color as string) }]}>
                                    {item.monitored ? 'Monitored' : 'Unmonitored'}
                                </Text>
                            </View>
                            {item.status === 'continuing' && (
                                <View style={[styles.statusBadge, { backgroundColor: styles.sonarrColor.color + '20' }]}>
                                    <Text style={[styles.statusText, { color: styles.sonarrColor.color as string }]}>Continuing</Text>
                                </View>
                            )}
                        </View>
                    </View>
        ...
        <View style={styles.container}>
            ...
            {isLoading ? (
                ...
                <FlatList
                    ...
                    refreshControl={
                        <RefreshControl refreshing={false} onRefresh={refetch} tintColor={styles.sonarrColor.color as string} />
                    }
                    ListEmptyComponent={
